    ...
    <div v-show="showFlag" class="food" ref="food">
      <div class="food-content">
        ...
        <div class="rating">
          ...
          <v-ratingselect @select="selectRating" @toggle="toggleContent" :ratings="food.ratings" :selectType="selectType" :onlyContent="onlyContent" :desc="desc"></v-ratingselect>
...
<script>
  ...
  export default {
    ...
    methods: {
      show() {
        this.showFlag = true;  // 让该详情页显示
        this.selectType = ALL;  // 在刚显示页面的时候初始化评论
        this.onlyContent = true;  // 在刚显示页面的时候初始化评论
